...
CREATE TABLE `__new_activities` (
	...
	`due_date` text,
	`created_by` integer,
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.705Z"',
	`updated_at` integer DEFAULT '"2026-07-14T22:52:01.705Z"'
);
...
CREATE TABLE `__new_clients` (
	...
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.697Z"',
	`updated_at` integer DEFAULT '"2026-07-14T22:52:01.697Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_credentials` (
	...
	`password_hash` text,
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.708Z"',
...
CREATE TABLE `__new_login_attempts` (
	...
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.712Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_password_reset_tokens` (
	...
	`used_at` integer,
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.720Z"',
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_projects` (
	...
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.701Z"',
	`updated_at` integer DEFAULT '"2026-07-14T22:52:01.701Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_refresh_tokens` (
	...
	`revoked_at` integer,
	`expires_at` integer NOT NULL,
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.716Z"',
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_sessions` (
	...
	`ip_address` text,
	`expires_at` integer NOT NULL,
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.723Z"',
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`status` text DEFAULT 'active',
	`created_at` integer DEFAULT '"2026-07-14T22:52:01.693Z"',
	`updated_at` integer DEFAULT '"2026-07-14T22:52:01.693Z"'
);
--> statement-breakpoint
