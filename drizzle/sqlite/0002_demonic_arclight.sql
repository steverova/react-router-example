CREATE TABLE `activities` (
	...
	`due_date` text,
	`created_by` integer,
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.863Z"',
	`updated_at` integer DEFAULT '"2026-07-14T03:42:25.863Z"'
);
...
CREATE TABLE `__new_clients` (
	...
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.855Z"',
	`updated_at` integer DEFAULT '"2026-07-14T03:42:25.855Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_credentials` (
	...
	`password_hash` text,
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.866Z"',
...
CREATE TABLE `__new_login_attempts` (
	...
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.869Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_password_reset_tokens` (
	...
	`used_at` integer,
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.874Z"',
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_projects` (
	...
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.858Z"',
	`updated_at` integer DEFAULT '"2026-07-14T03:42:25.858Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_refresh_tokens` (
	...
	`revoked_at` integer,
	`expires_at` integer NOT NULL,
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.872Z"',
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_sessions` (
	...
	`ip_address` text,
	`expires_at` integer NOT NULL,
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.877Z"',
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`status` text DEFAULT 'active',
	`created_at` integer DEFAULT '"2026-07-14T03:42:25.852Z"',
	`updated_at` integer DEFAULT '"2026-07-14T03:42:25.852Z"'
);
--> statement-breakpoint
